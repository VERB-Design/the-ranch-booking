    ...
    <article aria-labelledby={headingId} className={'transition-colors ' + borderClasses + ' ' + className}>
      <div className="flex max-md:flex-col">
        ...
        <div className="flex min-w-0 flex-1 flex-col p-5 md:p-7">
          ...
          <p className="mt-[9px] text-sm text-body">{room.detail}</p>
          <p className="mt-[17px] text-sm leading-relaxed text-body line-clamp-3">{room.desc}</p>
          {/* Price on the left, the action beside it on the right, bottoms
              aligned; on a phone the action drops beneath the price. */}
          <div className="mt-[21px] flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            {priceSlot}
